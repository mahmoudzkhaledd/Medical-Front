...
export default function CustomHeader({ linkTo, image }) {
    return (
        <section id='landing-header' className={`grid grid-2 landing-header__main-cont rounded-3xl px-10 ${image ? "py-6" : "py-10"} mb-5`}>
            <div className=' text-center flex flex-col items-center justify-center '>
                <h1 className='text-3xl font-bold text-center'> النص المراد وضعه في الهيدر</h1>
                <h1 className='text-lg font-normal text-gray-400 mt-5 text-center'> النص المراد وضعه في الهيدر النص المراد وضعه في الهيدر النص المراد وضعه في الهيدر النص المراد وضعه في الهيدر</h1>
