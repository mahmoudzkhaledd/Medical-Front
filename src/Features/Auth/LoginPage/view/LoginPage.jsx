                ...
                <div className="w-full bg-white rounded-lg shadow-lg dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form id="frm-login" className="space-y-4 md:space-y-6" action="#" onSubmit={(e) => e.preventDefault()}>
                            <TextBox name="email" initialValue={"mahmoud@mohmal.in"} disabled={loading} placeholder="الايميل" label="الايميل" />
                            <TextBox name="password" initialValue={"12345678"} disabled={loading} placeholder="الباسورد" label="الباسورد" type="password" />
