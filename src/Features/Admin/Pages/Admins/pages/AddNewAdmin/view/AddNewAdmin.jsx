                                ...
                                <TextBox initialValue={admin?.username} disabled={loading} name="username" placeholder="اسم المستخدم" label="اسم المستخدم" />
                                {
                                    !editMode && <>
                                        <div className="flex flex-row gap-3 w-100 items-end">
                                            ...
                                            <div>
                                                <Button onClick={randomPassword} height={45} className="my-auto" faicon="fa-solid fa-shuffle" />
                                            </div>
                                        </div>
                                        <div className="flex flex-row gap-3 w-100 items-end">
                                            ...
                                            <div>
                                                <Button onClick={randomPin} height={45} className="my-auto" faicon="fa-solid fa-shuffle" />
                                            </div>
                                        </div>
